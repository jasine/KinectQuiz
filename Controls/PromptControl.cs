...
namespace Microsoft.Samples.Kinect.InteractionGallery.Controls
{
    ...
    public class PromptControl : ContentControl
    {
        ...
        public static readonly RoutedEvent ConfirmStateEvent = EventManager.RegisterRoutedEvent("ConfirmState", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(PromptControl));

        public event RoutedEventHandler ConfirmState
        {
            add
            {
                this.AddHandler(ConfirmStateEvent,value);
            }
            remove
            {
                this.RemoveHandler(ConfirmStateEvent,value);
            }
        }

        public static readonly RoutedEvent CancelStateEvent = EventManager.RegisterRoutedEvent("CancelState", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(PromptControl));

        public event RoutedEventHandler CancelState
        {
            add
            {
                this.AddHandler(CancelStateEvent, value);
            }
            remove
            {
                this.RemoveHandler(CancelStateEvent, value);
            }
        }
