...
namespace Microsoft.Samples.Kinect.InteractionGallery.ViewModels
{
    ...
    public class KinectController : ViewModelBase
    {
        ...
        internal readonly Size originLogoSize = new Size() { Height = 230, Width = 230 };//change here to resize the logo，default in 1920*1080 resolution
        internal const double defaultLogoY=0.3;//chang here to change the vertical posion of the logo ,the percent of the screen height
        ...
        /// </summary>
        private EngagementStateManager engagementStateManager = new EngagementStateManager();
        ...
        private void SensorChooserOnKinectChanged(object sender, KinectChangedEventArgs e)
        {
            ...
            this.NavigationManager.NavigateToHome(DefaultNavigableContexts.AttractScreen2);
            this.IsUserEngaged = false;


            LogoVisibility = Visibility.Visible;
            AlertMessage = "按下这里开始问答";
        ...
        private void PerformEngagementChangeNavigation()
        {
            ...
            else if (!this.disengagementNavigationTimer.IsEnabled)
            {
                if (this.IsUserEngaged)
                {
                    ...
                    this.NavigationManager.NavigateToHome(DefaultNavigableContexts.QuestionScreen);
                    LogoVisibility = Visibility.Collapsed;
